            ...
            <div class="row justify-content-center">
              <div class="col-12 text-center footer-content">
                <div class="footer-title text-white">
                  <h1 class="fw-bold">IvyCafe.</h1>
                  <ul class="list-unstyled text-uppercase">
                    <li>open from 07:00 AM - 11:00 PM</li>
                    <li class="mb-3">Dehradun, India</li>
                  </ul>
                  <span class="me-3"><i class="fa-brands fa-instagram"></i> IvyCafe</span>
                  <span><i class="fa-brands fa-whatsapp"></i> +919876543215</span>
                </div>
              </div>
            </div>
            <div class="text-footer text-white text-center">
              <p class="m-0">
                Created with <i class="fa-solid fa-heart text-danger"></i> by <a href="" target="_blank" class="text-warning">Himnish Mehandiratta</a> © 2022 Copyright | All Rights Reserved
              </p>
            </div>
          </div>`;
}
